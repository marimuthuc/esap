 ...
 * @author Thomas Thuem
 */
public class CMCorePlugin extends AbstractCorePlugin {

	private static CMCorePlugin plugin;

	public static final String PLUGIN_ID = "de.ovgu.featureide.core.context";
	...
	public void start(BundleContext context) throws Exception {
		...
		FMFactoryManager.setExtensionLoader(
				new EclipseExtensionLoader<>(PLUGIN_ID, IFeatureModelFactory.extensionPointID, IFeatureModelFactory.extensionID, IFeatureModelFactory.class));
		FMFormatManager.setExtensionLoader(
				new EclipseExtensionLoader<>(PLUGIN_ID, IFeatureModelFormat.extensionPointID, IFeatureModelFormat.extensionID, IFeatureModelFormat.class));
		ConfigFormatManager.setExtensionLoader(
				new EclipseExtensionLoader<>(PLUGIN_ID, IConfigurationFormat.extensionPointID, IConfigurationFormat.extensionID, IConfigurationFormat.class));
...
//		FMFactoryManager.setExtensionLoader(new CoreExtensionLoader<>(new DefaultFeatureModelFactory(), new ExtendedFeatureModelFactory()));
	...
	public static CMCorePlugin getDefault() {
		return plugin;
	}
