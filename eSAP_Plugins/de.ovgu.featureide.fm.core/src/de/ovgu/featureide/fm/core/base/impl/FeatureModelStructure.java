...
public class FeatureModelStructure implements IFeatureModelStructure {
	...
	public boolean hasEnergyHungry() {
		for (final IFeature f : correspondingFeatureModel.getVisibleFeatures(showHiddenFeatures)) {
			if (f.getStructure().isEnergyHungry()) {
				return true;
			}
		}
		return false;
	...
	public boolean hasContextModeling() {
		for (final IFeature f : correspondingFeatureModel.getVisibleFeatures(showHiddenFeatures)) {
			if (f.getStructure().isContextModeling()) {
				return true;
			}
		}
		return false;
	...
	public boolean hasEnergyEffAlt() {
		for (final IFeature f : correspondingFeatureModel.getVisibleFeatures(showHiddenFeatures)) {
			if (f.getStructure().isEnergyEffAlt()) {
				return true;
			}
		}
		return false;
	...
	public boolean hasEnergyFriendly() {
		for (final IFeature f : correspondingFeatureModel.getVisibleFeatures(showHiddenFeatures)) {
			if (f.getStructure().isEnergyFriendly()) {
				return true;
			}
		}
		return false;
	...
	@Override
	public boolean hasDisEhungry() {
		for (final IFeature f : correspondingFeatureModel.getFeatures()) {
			if (f.getProperty().getFeatureStatus() == FeatureStatus.DISALLOWED_EHUNGRY) {
				return true;
			}
		}
		return false;
