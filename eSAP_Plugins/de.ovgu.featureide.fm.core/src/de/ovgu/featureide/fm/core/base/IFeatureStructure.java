...
public interface IFeatureStructure {
	...
	boolean isContextModeling();

	boolean isComposerContext();

	boolean isEnergyHungry();

	boolean isEnergyEffAlt();

	boolean isEnergyFriendly();
	...
	void setComposerContext(boolean value);
	 ...
	 * @param b
	 */
	void setEnergyHungry(boolean energyhungry);

	void setEnergyHungryTag(boolean energyhungry);

	/**
	 * @param b
	 */
	void setEnergyFriendly(boolean b);
