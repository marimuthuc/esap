...
public interface IFMPropertyPage {
	...
	static final String COLOR_ENERGYHUNGRY_LABEL = "Energy Hungry feature color:";
	static final String COLOR_PRIMARY_LABEL = "Primary Context color:";
	static final String COLOR_SECONDARY_LABEL = "Secondary Context color:";
	static final String COLOR_USER_LABEL = "User Context color:";
	static final String COLOR_CONTEXTMODELING_LABEL = "ContextModeling feature color:";
	static final String COLOR_ENERGYFRIENDLY_LABEL = "Energy Friendly feature color:";
	static final String COLOR_ENERGYEFFALT_LABEL = "Energy Efficient Alternative feature color:";
	...
	static final String COLOR_ENERGYHUNGRY_TIP = "";
	static final String COLOR_PRIMARY_TIP = "";
	static final String COLOR_SECONDARY_TIP = "";
	static final String COLOR_USER_TIP = "";
	static final String COLOR_CONTEXTMODELING_TIP = "";
	static final String COLOR_ENERGYFRIENDLY_TIP = "";
	static final String COLOR_ENERGYEFFALT_TIP = "";
