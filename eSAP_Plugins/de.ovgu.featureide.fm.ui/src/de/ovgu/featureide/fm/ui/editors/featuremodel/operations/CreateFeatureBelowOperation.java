...
public class CreateFeatureBelowOperation extends AbstractFeatureModelOperation {
	...
	protected FeatureIDEEvent operation() {
		...
		/*
		 * if (feature.getStructure().isEnergyFriendly() && (feature.getStructure().getChildrenCount() == 0)) {
		 * // newFeature.getStructure().setMandatory(!newFeature.getStructure().isMandatory());
