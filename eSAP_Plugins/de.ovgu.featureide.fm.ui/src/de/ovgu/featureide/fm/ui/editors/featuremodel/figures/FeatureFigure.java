...
public class FeatureFigure extends ModelElementFigure implements GUIDefaults {
	...
	public void setProperties() {
		...
		} else if (feature.getStructure().isEnergyHungry()) {
			setBackgroundColor(FMPropertyManager.getEnergyHungryFeatureBackgroundColor());
		} else if (feature.getStructure().isEnergyFriendly()) {
			setBackgroundColor(FMPropertyManager.getEnergyFriendlyFeatureBackgroundColor());
		} else if (feature.getStructure().isEnergyEffAlt()) {
			setBackgroundColor(FMPropertyManager.getEnergyEffAltFeatureBackgroundColor());
		} else if (feature.getStructure().isPrimary()) {
			setBackgroundColor(FMPropertyManager.getPrimaryFeatureBackgroundColor());
		} else if (feature.getStructure().isSecondary()) {
			setBackgroundColor(FMPropertyManager.getSecondaryFeatureBackgroundColor());
		} else if (feature.getStructure().isUser()) {
			setBackgroundColor(FMPropertyManager.getUserFeatureBackgroundColor());
		} else if (!feature.getStructure().isConcrete()) {
			setBackgroundColor(FMPropertyManager.getAbstractFeatureBackgroundColor());
		} else if (feature.getStructure().isContextModeling()) {
			setBackgroundColor(FMPropertyManager.getContextModelingFeatureBackgroundColor());
		}
