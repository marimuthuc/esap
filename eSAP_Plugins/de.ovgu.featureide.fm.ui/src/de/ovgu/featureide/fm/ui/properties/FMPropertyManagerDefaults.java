...
public class FMPropertyManagerDefaults {
	...
	static final QualifiedName QN_FEATURE_ENERGYHUNGRY = createName("energyhungry");
	static final QualifiedName QN_FEATURE_PRIMARY = createName("Primary Influencing Context");
	static final QualifiedName QN_FEATURE_SECONDARY = createName("Secondary Influencing Context");
	static final QualifiedName QN_FEATURE_USER = createName("User Influencing Context");
	static final QualifiedName QN_FEATURE_CONTEXTMODELING = createName("contextmodeling");
	static final QualifiedName QN_FEATURE_ENERGYEFFALT = createName("energyeffalt");
	static final QualifiedName QN_FEATURE_ENERGYFRIENDLY = createName("energyfriendly");
