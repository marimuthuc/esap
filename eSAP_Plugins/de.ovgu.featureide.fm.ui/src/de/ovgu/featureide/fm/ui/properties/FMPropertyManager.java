...
public class FMPropertyManager extends FMPropertyManagerDefaults implements GUIDefaults {
	...
	private volatile static Color CURRENT_ENERGYHUNGRY_BACKGROUND = null;
	private volatile static Color CURRENT_PRIMARY_BACKGROUND = null;
	private volatile static Color CURRENT_SECONDARY_BACKGROUND = null;
	private volatile static Color CURRENT_USER_BACKGROUND = null;
	private volatile static Color CURRENT_CONTEXTMODELING_BACKGROUND = null;
	private volatile static Color CURRENT_ENERGYEFFALT_BACKGROUND = null;
	private volatile static Color CURRENT_ENERGYFRIENDLY_BACKGROUND = null;
	...
	public static void reset() {
		...
		CURRENT_ENERGYHUNGRY_BACKGROUND = null;
		CURRENT_PRIMARY_BACKGROUND = null;
		CURRENT_SECONDARY_BACKGROUND = null;
		CURRENT_USER_BACKGROUND = null;
		CURRENT_CONTEXTMODELING_BACKGROUND = null;
		CURRENT_ENERGYEFFALT_BACKGROUND = null;
		CURRENT_ENERGYFRIENDLY_BACKGROUND = null;
	...
	public static void setEnergyHungryFeatureBackgroundColor(Color color) {
		CURRENT_ENERGYHUNGRY_BACKGROUND = color;
		setColor(QN_FEATURE_ENERGYHUNGRY, color);
	}

	public static void setPrimaryFeatureBackgroundColor(Color color) {
		CURRENT_PRIMARY_BACKGROUND = color;
		setColor(QN_FEATURE_PRIMARY, color);
	}

	public static void setSecondaryFeatureBackgroundColor(Color color) {
		CURRENT_SECONDARY_BACKGROUND = color;
		setColor(QN_FEATURE_SECONDARY, color);
	}

	public static void setUserFeatureBackgroundColor(Color color) {
		CURRENT_USER_BACKGROUND = color;
		setColor(QN_FEATURE_USER, color);
	}

	public static void setContextModelingFeatureBackgroundColor(Color color) {
		CURRENT_CONTEXTMODELING_BACKGROUND = color;
		setColor(QN_FEATURE_CONTEXTMODELING, color);
	}

	public static void setEnergyEffAltFeatureBackgroundColor(Color color) {
		CURRENT_ENERGYEFFALT_BACKGROUND = color;
		setColor(QN_FEATURE_ENERGYEFFALT, color);
	}

	public static void setEnergyFriendlyFeatureBackgroundColor(Color color) {
		CURRENT_ENERGYFRIENDLY_BACKGROUND = color;
		setColor(QN_FEATURE_ENERGYFRIENDLY, color);
	}
	...
	public static Color getEnergyHungryFeatureBackgroundColor() {
		if (CURRENT_ENERGYHUNGRY_BACKGROUND == null) {
			CURRENT_ENERGYHUNGRY_BACKGROUND = getColor(QN_FEATURE_ENERGYHUNGRY, ENERGYHUNGRY_BACKGROUND);
		}
		return CURRENT_ENERGYHUNGRY_BACKGROUND;
	}

	public static Color getPrimaryFeatureBackgroundColor() {
		if (CURRENT_PRIMARY_BACKGROUND == null) {
			CURRENT_PRIMARY_BACKGROUND = getColor(QN_FEATURE_PRIMARY, PRIMARY_BACKGROUND);
		}
		return CURRENT_PRIMARY_BACKGROUND;
	}

	public static Color getSecondaryFeatureBackgroundColor() {
		if (CURRENT_SECONDARY_BACKGROUND == null) {
			CURRENT_SECONDARY_BACKGROUND = getColor(QN_FEATURE_SECONDARY, SECONDARY_BACKGROUND);
		}
		return CURRENT_SECONDARY_BACKGROUND;
	}

	public static Color getUserFeatureBackgroundColor() {
		if (CURRENT_USER_BACKGROUND == null) {
			CURRENT_USER_BACKGROUND = getColor(QN_FEATURE_USER, USER_BACKGROUND);
		}
		return CURRENT_USER_BACKGROUND;
	}

	public static Color getContextModelingFeatureBackgroundColor() {
		if (CURRENT_CONTEXTMODELING_BACKGROUND == null) {
			CURRENT_CONTEXTMODELING_BACKGROUND = getColor(QN_FEATURE_CONTEXTMODELING, CONTEXTMODELING_BACKGROUND);
		}
		return CURRENT_CONTEXTMODELING_BACKGROUND;
	}

	public static Color getEnergyEffAltFeatureBackgroundColor() {
		if (CURRENT_ENERGYEFFALT_BACKGROUND == null) {
			CURRENT_ENERGYEFFALT_BACKGROUND = getColor(QN_FEATURE_ENERGYEFFALT, ENERGYEFFALT_BACKGROUND);
		}
		return CURRENT_ENERGYEFFALT_BACKGROUND;
	}

	public static Color getEnergyFriendlyFeatureBackgroundColor() {
		if (CURRENT_ENERGYFRIENDLY_BACKGROUND == null) {
			CURRENT_ENERGYFRIENDLY_BACKGROUND = getColor(QN_FEATURE_ENERGYFRIENDLY, ENERGYFRIENDLY_BACKGROUND);
		}
		return CURRENT_ENERGYFRIENDLY_BACKGROUND;
	}
	...
	public static Border getEnergyHungryFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getEnergyHungryBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getEnergyHungryBorderColor(), 1);
	}

	public static Border getPrimaryFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getPrimaryBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getPrimaryBorderColor(), 1);
	}

	public static Border getSecondaryFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getSecondaryBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getSecondaryBorderColor(), 1);
	}

	public static Border getUserFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getUserBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getUserBorderColor(), 1);
	}

	public static Border getContextModelingFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getContextModelingBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getContextModelingBorderColor(), 1);
	}

	public static Border getEnergyEffAltFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getEnergyEffAltBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getEnergyEffAltBorderColor(), 1);
	}

	public static Border getEnergyFriendlyFeatureBorder(boolean selected) {
		if (selected) {
			return GUIBasics.createLineBorder(getEnergyFriendlyBorderColor(), 3);
		}
		return GUIBasics.createLineBorder(getEnergyFriendlyBorderColor(), 1);
	}
	...
	private static Color getEnergyHungryBorderColor() {
		return GUIBasics.createBorderColor(getEnergyHungryFeatureBackgroundColor());
	}

	private static Color getPrimaryBorderColor() {
		return GUIBasics.createBorderColor(getPrimaryFeatureBackgroundColor());
	}

	private static Color getSecondaryBorderColor() {
		return GUIBasics.createBorderColor(getSecondaryFeatureBackgroundColor());
	}

	private static Color getUserBorderColor() {
		return GUIBasics.createBorderColor(getUserFeatureBackgroundColor());
	}

	private static Color getContextModelingBorderColor() {
		return GUIBasics.createBorderColor(getContextModelingFeatureBackgroundColor());
	}

	private static Color getEnergyEffAltBorderColor() {
		return GUIBasics.createBorderColor(getEnergyEffAltFeatureBackgroundColor());
	}

	private static Color getEnergyFriendlyBorderColor() {
		return GUIBasics.createBorderColor(getEnergyFriendlyFeatureBackgroundColor());
	}
...
//		FMCorePlugin.getDefault().logInfo(reason.getSourceElement().getName() + " got color " + GUIBasics.createColor(reason.getConfidence(), 0.0, 0.0));
	...
	public static LinkedList<QualifiedName> getQualifiedNames() {
		...
		names.add(QN_FEATURE_ENERGYHUNGRY);
		names.add(QN_FEATURE_PRIMARY);
		names.add(QN_FEATURE_SECONDARY);
		names.add(QN_FEATURE_USER);
		names.add(QN_FEATURE_CONTEXTMODELING);
		names.add(QN_FEATURE_ENERGYEFFALT);
		names.add(QN_FEATURE_ENERGYFRIENDLY);
