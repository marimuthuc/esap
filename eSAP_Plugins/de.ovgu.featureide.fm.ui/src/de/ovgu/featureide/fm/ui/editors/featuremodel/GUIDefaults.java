...
public interface GUIDefaults {
	...
	public static final Color ENERGYHUNGRY_BACKGROUND = GUIBasics.createColor(1.0, 0.0, 0.0);
	public static final Color ENERGYHUNGRY_BORDER_COLOR = GUIBasics.createBorderColor(ENERGYHUNGRY_BACKGROUND);
	public static final Border ENERGYHUNGRY_BORDER = new LineBorder(ENERGYHUNGRY_BORDER_COLOR, 1);
	public static final Color ENERGYHUNGRY_SELECTED_BORDER_COLOR = ENERGYHUNGRY_BORDER_COLOR;
	public static final Border ENERGYHUNGRY_SELECTED_BORDER = new LineBorder(ENERGYHUNGRY_SELECTED_BORDER_COLOR, 3);

	public static final Color CONTEXTMODELING_BACKGROUND = GUIBasics.createColor(0.5, 0.0, 0.5);
	public static final Color CONTEXTMODELING_BORDER_COLOR = GUIBasics.createBorderColor(CONTEXTMODELING_BACKGROUND);
	public static final Border CONTEXTMODELING_BORDER = new LineBorder(CONTEXTMODELING_BORDER_COLOR, 1);
	public static final Color CONTEXTMODELING_SELECTED_BORDER_COLOR = CONTEXTMODELING_BORDER_COLOR;
	public static final Border CONTEXTMODELING_SELECTED_BORDER = new LineBorder(CONTEXTMODELING_SELECTED_BORDER_COLOR, 3);

	public static final Color PRIMARY_BACKGROUND = GUIBasics.createColor(1.0, 1.0, 0);
	public static final Color PRIMARY_BORDER_COLOR = GUIBasics.createBorderColor(PRIMARY_BACKGROUND);
	public static final Border PRIMARY_BORDER = new LineBorder(PRIMARY_BORDER_COLOR, 1);
	public static final Color PRIMARY_SELECTED_BORDER_COLOR = PRIMARY_BORDER_COLOR;
	public static final Border PRIMARY_SELECTED_BORDER = new LineBorder(PRIMARY_SELECTED_BORDER_COLOR, 3);

	public static final Color SECONDARY_BACKGROUND = GUIBasics.createColor(1.0, 0.0, 1.0);
	public static final Color SECONDARY_BORDER_COLOR = GUIBasics.createBorderColor(SECONDARY_BACKGROUND);
	public static final Border SECONDARY_BORDER = new LineBorder(SECONDARY_BORDER_COLOR, 1);
	public static final Color SECONDARY_SELECTED_BORDER_COLOR = SECONDARY_BORDER_COLOR;
	public static final Border SECONDARY_SELECTED_BORDER = new LineBorder(SECONDARY_SELECTED_BORDER_COLOR, 3);

	public static final Color USER_BACKGROUND = GUIBasics.createColor(0.5, 0.0, 0.0);
	public static final Color USER_BORDER_COLOR = GUIBasics.createBorderColor(USER_BACKGROUND);
	public static final Border USER_BORDER = new LineBorder(USER_BORDER_COLOR, 1);
	public static final Color USER_SELECTED_BORDER_COLOR = USER_BORDER_COLOR;
	public static final Border USER_SELECTED_BORDER = new LineBorder(USER_SELECTED_BORDER_COLOR, 3);

	public static final Color ENERGYFRIENDLY_BACKGROUND = GUIBasics.createColor(0.0, 1.0, 0.0);
	public static final Color ENERGYFRIENDLY_BORDER_COLOR = GUIBasics.createBorderColor(ENERGYFRIENDLY_BACKGROUND);
	public static final Border ENERGYFRIENDLY_BORDER = new LineBorder(ENERGYFRIENDLY_BORDER_COLOR, 1);
	public static final Color ENERGYFRIENDLY_SELECTED_BORDER_COLOR = ENERGYFRIENDLY_BORDER_COLOR;
	public static final Border ENERGYFRIENDLY_SELECTED_BORDER = new LineBorder(ENERGYFRIENDLY_SELECTED_BORDER_COLOR, 3);

	public static final Color ENERGYEFFALT_BACKGROUND = GUIBasics.createColor(1.0, 0.6, 0.0);
	public static final Color ENERGYEFFALT_BORDER_COLOR = GUIBasics.createBorderColor(ENERGYEFFALT_BACKGROUND);
	public static final Border ENERGYEFFALT_BORDER = new LineBorder(ENERGYEFFALT_BORDER_COLOR, 1);
	public static final Color ENERGYEFFALT_SELECTED_BORDER_COLOR = ENERGYEFFALT_BORDER_COLOR;
	public static final Border ENERGYEFFALT_SELECTED_BORDER = new LineBorder(ENERGYEFFALT_SELECTED_BORDER_COLOR, 3);
