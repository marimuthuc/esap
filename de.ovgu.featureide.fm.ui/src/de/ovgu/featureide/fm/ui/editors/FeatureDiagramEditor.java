...
import de.ovgu.featureide.fm.ui.editors.featuremodel.actions.ContextModelingAction;
...
import de.ovgu.featureide.fm.ui.editors.featuremodel.actions.EnergyHungryAction;
...
import de.ovgu.featureide.fm.ui.editors.featuremodel.actions.PrimaryAction;
...
import de.ovgu.featureide.fm.ui.editors.featuremodel.actions.SecondaryAction;
...
import de.ovgu.featureide.fm.ui.editors.featuremodel.actions.UserAction;
...
public class FeatureDiagramEditor extends FeatureModelEditorPage implements GUIDefaults, IEventListener {
	...
	private EnergyHungryAction energyHungryAction;
	private PrimaryAction primaryAction;
	private SecondaryAction secondaryAction;
	private UserAction userAction;
	private ContextModelingAction contextModelingAction;
	...
	private void createActions() {
		...
		energyHungryAction = addAction(new EnergyHungryAction(viewer, featureModel));
		primaryAction = addAction(new PrimaryAction(viewer, featureModel));
		secondaryAction = addAction(new SecondaryAction(viewer, featureModel));
		userAction = addAction(new UserAction(viewer, featureModel));
		contextModelingAction = addAction(new ContextModelingAction(viewer, featureModel));
...
//		}
	...
	private void fillContextMenu(IMenuManager menuManager) {
		...
		if (isFeatureMenu(selection)) {
			...
			menuManager.add(new Separator());
			menuManager.add(energyHungryAction);
			menuManager.add(new Separator());
			menuManager.add(primaryAction);
			menuManager.add(secondaryAction);
			menuManager.add(userAction);
			// menuManager.add(contextModelingAction);
			menuManager.add(new Separator());
	...
	public IAction getDiagramAction(String workbenchActionID) {
		...
		if (EnergyHungryAction.ID.equals(workbenchActionID)) {
			return energyHungryAction;
		}
		if (UserAction.ID.equals(workbenchActionID)) {
			return userAction;
		}
		if (PrimaryAction.ID.equals(workbenchActionID)) {
			return primaryAction;
		}
		if (SecondaryAction.ID.equals(workbenchActionID)) {
			return secondaryAction;
		}
		if (ContextModelingAction.ID.equals(workbenchActionID)) {
			return contextModelingAction;
		}
