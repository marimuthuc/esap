...
public class FMPropertyPage extends PropertyPage implements IFMPropertyPage, GUIDefaults {
	...
	ColorSelector selectorLegendBackground, selectorConcreteBackground, selectorAbstractBackground, selectorDeadBackground, selectorLegendBorder,
			selectorDiagramBackground, selectorConstraint, selectorConnection, selectorWarning, selectorEnergyHungryBackground,
			selectorEnergyFriendlyBackground, selectorEnergyEffAltBackground, selectorContextModelingBackground, selectorPrimaryBackground,
			selectorSecondaryBackground, selectorUserBackground;
	...
	private void addColorGroup(Composite composite) {
		...
		selectorEnergyHungryBackground = createSelectorEntry(colorGroup, COLOR_ENERGYHUNGRY_LABEL,
				FMPropertyManager.getEnergyHungryFeatureBackgroundColor().getRGB(), COLOR_ENERGYHUNGRY_TIP);
		selectorPrimaryBackground =
			createSelectorEntry(colorGroup, COLOR_PRIMARY_LABEL, FMPropertyManager.getPrimaryFeatureBackgroundColor().getRGB(), COLOR_PRIMARY_TIP);
		selectorSecondaryBackground =
			createSelectorEntry(colorGroup, COLOR_SECONDARY_LABEL, FMPropertyManager.getSecondaryFeatureBackgroundColor().getRGB(), COLOR_SECONDARY_TIP);
		selectorUserBackground = createSelectorEntry(colorGroup, COLOR_USER_LABEL, FMPropertyManager.getUserFeatureBackgroundColor().getRGB(), COLOR_USER_TIP);

		selectorContextModelingBackground = createSelectorEntry(colorGroup, COLOR_CONTEXTMODELING_LABEL,
				FMPropertyManager.getConcreteFeatureBackgroundColor().getRGB(), COLOR_CONTEXTMODELING_TIP);
		selectorEnergyFriendlyBackground = createSelectorEntry(colorGroup, COLOR_ENERGYFRIENDLY_LABEL,
				FMPropertyManager.getConcreteFeatureBackgroundColor().getRGB(), COLOR_ENERGYFRIENDLY_TIP);
		selectorEnergyEffAltBackground =
			createSelectorEntry(colorGroup, COLOR_ENERGYEFFALT_LABEL, FMPropertyManager.getConcreteFeatureBackgroundColor().getRGB(), COLOR_ENERGYEFFALT_TIP);
	...
	private void performFeatureGroup() {
		...
		FMPropertyManager.setEnergyHungryFeatureBackgroundColor(new Color(null, selectorEnergyHungryBackground.getColorValue()));
		FMPropertyManager.setPrimaryFeatureBackgroundColor(new Color(null, selectorPrimaryBackground.getColorValue()));
		FMPropertyManager.setSecondaryFeatureBackgroundColor(new Color(null, selectorSecondaryBackground.getColorValue()));
		FMPropertyManager.setUserFeatureBackgroundColor(new Color(null, selectorUserBackground.getColorValue()));
		FMPropertyManager.setContextModelingFeatureBackgroundColor(new Color(null, selectorContextModelingBackground.getColorValue()));
		FMPropertyManager.setEnergyEffAltFeatureBackgroundColor(new Color(null, selectorEnergyEffAltBackground.getColorValue()));
		FMPropertyManager.setEnergyFriendlyFeatureBackgroundColor(new Color(null, selectorEnergyFriendlyBackground.getColorValue()));
	...
	private void resetFeatureGroup() {
		...
		selectorEnergyHungryBackground.setColorValue(ENERGYHUNGRY_BACKGROUND.getRGB());
		selectorSecondaryBackground.setColorValue(SECONDARY_BACKGROUND.getRGB());
		selectorPrimaryBackground.setColorValue(PRIMARY_BACKGROUND.getRGB());
		selectorUserBackground.setColorValue(USER_BACKGROUND.getRGB());
		selectorContextModelingBackground.setColorValue(CONTEXTMODELING_BACKGROUND.getRGB());
		selectorEnergyFriendlyBackground.setColorValue(ENERGYFRIENDLY_BACKGROUND.getRGB());
		selectorEnergyEffAltBackground.setColorValue(ENERGYEFFALT_BACKGROUND.getRGB());
	...
	private void updateFeatureGroup() {
		...
		selectorEnergyFriendlyBackground.setColorValue(FMPropertyManager.getEnergyFriendlyFeatureBackgroundColor().getRGB());
		selectorEnergyHungryBackground.setColorValue(FMPropertyManager.getEnergyHungryFeatureBackgroundColor().getRGB());
		selectorPrimaryBackground.setColorValue(FMPropertyManager.getPrimaryFeatureBackgroundColor().getRGB());
		selectorSecondaryBackground.setColorValue(FMPropertyManager.getSecondaryFeatureBackgroundColor().getRGB());
		selectorUserBackground.setColorValue(FMPropertyManager.getUserFeatureBackgroundColor().getRGB());
		selectorContextModelingBackground.setColorValue(FMPropertyManager.getContextModelingFeatureBackgroundColor().getRGB());
		// selectorHiddenBackground.setColorValue(PersistentPropertyManager.getHiddenFeatureBackgroundColor().getRGB());
		selectorEnergyEffAltBackground.setColorValue(FMPropertyManager.getEnergyEffAltFeatureBackgroundColor().getRGB());
